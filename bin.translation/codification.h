...
enum OP {EOC = 0, WRONGOP = 0, END = 101, ADD, SUB,
    ...
    POPDX, PUSH = 115, JE = 116, JNE, JA, JAE, JB, JBE, JMP, CALL = 123};
#define MAXMARK 100
#define MAXOP 124
...
const uint8_t exitinst[] = {0x6A, 0x07, 0x48, 0x89, 0xE6, 0xBF, 0x01, 0x00, 0x00, 0x00, 0xBA, 0x01, 0x00, 0x00, 0x00, 0xB8, 0x04, 0x00, 0x00, 0x02, 0x0F, 0x05, 0xb8, 0x01, 0x00, 0x00, 0x02, 0xbf, 0x00, 0x00, 0x00, 0x00, 0x0f, 0x05, 0xc3};
...
const uint8_t callinst[] = {0x41, 0xff, 0x92};

const uint8_t jmpinst[] = {0x41, 0xff, 0xa2};

const uint8_t jeinst[] = {0xf2, 0x0f, 0x10, 0x45, 0x00, 0x48, 0x83, 0xed, 0x10, 0x66, 0x0f, 0x2f, 0x45, 0x08, 0x75, 0x07, 0x41, 0xff, 0xa2};

const uint8_t jneinst[] = {0xf2, 0x0f, 0x10, 0x45, 0x00, 0x48, 0x83, 0xed, 0x10, 0x66, 0x0f, 0x2f, 0x45, 0x08, 0x74, 0x07, 0x41, 0xff, 0xa2};

const uint8_t jainst[] = {0xf2, 0x0f, 0x10, 0x45, 0x00, 0x48, 0x83, 0xed, 0x10, 0x66, 0x0f, 0x2f, 0x45, 0x08, 0x76, 0x07, 0x41, 0xff, 0xa2};

const uint8_t jaeinst[] = {0xf2, 0x0f, 0x10, 0x45, 0x00, 0x48, 0x83, 0xed, 0x10, 0x66, 0x0f, 0x2f, 0x45, 0x08, 0x72, 0x07, 0x41, 0xff, 0xa2};

const uint8_t jbinst[] = {0xf2, 0x0f, 0x10, 0x45, 0x00, 0x48, 0x83, 0xed, 0x10, 0x66, 0x0f, 0x2f, 0x45, 0x08, 0x73, 0x07, 0x41, 0xff, 0xa2};

const uint8_t jbeinst[] = {0xf2, 0x0f, 0x10, 0x45, 0x00, 0x48, 0x83, 0xed, 0x10, 0x66, 0x0f, 0x2f, 0x45, 0x08, 0x77, 0x07, 0x41, 0xff, 0xa2};
